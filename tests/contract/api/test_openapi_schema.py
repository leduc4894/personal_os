...
ROUTE_OPERATION_IDS: dict[str, dict[str, str]] = {
    ...
    "/api/admin/source-lifecycle/rejections": {"get": "getSourceLifecycleRejectionDiagnostics"},
...
STRICT_MODEL_SCHEMA_NAMES: tuple[str, ...] = (
    ...
    "ApiEnvelope_ExclusionPolicyDiagnosticsData_",
    ...
    "ApiEnvelope_SourceLifecycleDiagnosticsData_",
