...
Golden (snapshot/regression) tests are added by a **later spec** that produces
a deterministic, reviewable artifact worth pinning (for example: serialized
metadata documents, generated API clients, or rendered citation payloads).
Until that spec lands, this directory intentionally contains only this README.
