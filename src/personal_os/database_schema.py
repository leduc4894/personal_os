...
#: ``grant_poll`` member of the throttle bucket-kind CHECK), which stacks on
#: the revision ``20260829_01`` (the append-time submitted policy verdict
#: column), which stacks on the multipart revision ``20260828_04`` (the sealed
#: raw multipart operation token), which stacks on ``20260828_01..03``
#: (multipart sessions/parts, widened operation size bound, deferred provider
#: identity), which stack on the device sync revision ``20260826_02`` (the
