...
#: readiness accepts exactly this head and nothing else. The grant-poll pacing
#: bucket kind revision ``20260901_01`` (the seventh closed ``grant_poll``
#: member of the throttle bucket-kind CHECK) stacks on the revision
...
CANONICAL_POSTGRESQL_SCHEMA_REVISION: Final[str] = "20260901_01"
