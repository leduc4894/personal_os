...
export type paths = {
    ...
    readonly "/api/admin/metrics": {
         ...
         * @description Render the closed policy counters in Prometheus text format.
         */
        readonly get: operations["getMetricsExposition"];
        readonly put?: never;
        readonly post?: never;
        readonly delete?: never;
        readonly options?: never;
...
export interface operations {
    ...
    readonly getMetricsExposition: {
        ...
        readonly requestBody?: never;
        readonly responses: {
            /** @description The closed policy evaluation and publication counters rendered in the Prometheus text exposition format */
            readonly 200: {
                headers: {
                    readonly [name: string]: unknown;
                };
                content: {
                    readonly "text/plain; version=0.0.4; charset=utf-8": string;
                };
            };
        };
    };
