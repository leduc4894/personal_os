...
Implementation is complete at `e197dbd` (`test: scope live restore counts to
canonical tables`), with documentation evidence through `ce32d75`. The
protected R2 live acceptance passed on the same code tree in GitHub Actions
run [32733357145](https://github.com/leduc4894/personal_os/actions/runs/32733357145):
...
| Protected canonical-core acceptance | Passed | GitHub Actions run 32733357145, `Ubuntu phase-one acceptance live gate`, completed in 2m36s, including exact-key cleanup and sanitized JUnit upload. |
