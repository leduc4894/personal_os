...
| 2026-08-24 | closed-reason-surfacing | Live smoke round of the remediation surfaces: wrong-origin token ✓, terminal cleared-reason ✓, staleness ✓ (all observed 2026-09-01) — REMAINING is the lifecycle rejection ring readback (locator conflict on restore); the 2026-09-03 re-fire was blocked before any journey step by the untitled-transit capture flag + repair deadlock, BOTH now fixed (`29f65f5`, `f7a92e5`); the stack/readback path/two-vault fixture are proven, so the re-fire is unblocked | Before Child 9 operations acceptance | [handoff §4](2026-08-24-closed-reason-surfacing-remediation.md); [round handoff](2026-09-01-policy-diagnostics-metrics-sink-and-live-smoke.md); [block handoff](2026-09-03-lifecycle-rejection-ring-live-readback.md) |
