...
Scope: repository skeleton, contracts, PostgreSQL baseline, Cloudflare R2-backed CAS, production/test bucket isolation, auth, config, CI và local Docker dependencies.
